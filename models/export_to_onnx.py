...
if __name__ == '__main__':
    saved_model_path = 'model_variants/best_model/efficientnet-model-variants_best_model.h5'
    onnx_output_path = 'onnx/model_variants/efficientnet-model-variants_best_model.onnx'
